...
public class contactusPage {
	...
	public void contactus() throws InterruptedException {
		...
		Thread.sleep(3000);
		WebElement oredrreferencedropdown=driver.findElement(By.xpath("//*[@id=\'center_column\']/form/fieldset/div[1]/div[1]/div[2]/div/select"));
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("//input[@id='fileUpload']")).sendKeys("C:\\Users\\BLTuser.BLT1019\\Desktop\\Book3.xlsx");
		driver.findElement(By.xpath("//textarea[@id='message']")).sendKeys("hey.....i have a problem......please help me");
